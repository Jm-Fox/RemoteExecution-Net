namespace RemoteExecution.Executors
{
	...
	public enum ReturnPolicy
	{
		...
		TwoWay,
		/// <summary>
		/// One way method - remote executor does not wait for response, even if it isn't void (if exception is thrown on remote end, it will not be passed back to method caller).
		/// </summary>
		OneWay,
	}
}